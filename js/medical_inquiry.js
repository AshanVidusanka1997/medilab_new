...
function save_inv() {
    ...
    if (document.getElementById('gamca_txt').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Please Enter GAMCA NO</span></div>";
        return false;
    }
    if (document.getElementById('eno_txt').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Please Enter E NO</span></div>";
        return false;
    }
